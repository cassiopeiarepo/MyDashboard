...
QStringList QStringUtils::splitLinesToVectorWindows(const QString& str) {
	QStringList result;
...
bool QStringUtils::loadStringFromFileWindows(const QString& file_path, QString& str) {
...
bool QStringUtils::loadStringFromFileUnix(const QString& file_path, QString& str) {
	QFile file(file_path);
...
bool QStringUtils::StrToIntArray(const QString& str, int* _array, int size) {
...
bool QStringUtils::StrToFloatArray(const QString& str, float* _array, int size) {
	QStringList items = str.split(",");
