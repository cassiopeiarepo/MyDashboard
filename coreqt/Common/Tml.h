...
public:
    ...
    int getArgEnd(QStringList& lines);
...
public:
    TmlSource() : error(false), error_line(0), error_pos(0), error_msg(""), line(0), pos(-1), ch(' ') {}
...
public:
    ...
    int getNameEnd(QStringList& lines);
    int getNameEnd2(QStringList& lines);
...
private:
    ...
    QString data;
    bool empty_element;
    QList<TmlArgument*> args;

    TmlNode* parent;
    QList<TmlNode*> childs;
