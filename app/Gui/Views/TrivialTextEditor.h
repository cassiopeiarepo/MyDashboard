...
protected:
    Vector<TTELine*> lines;

    Vector<TTELine*> stringToLines(QString& str);
...
protected:
    ...
    void insertString(int& line_nr, int& pos, QString& str);
    ...
    Vector<int> buffer_line_size;

    HistoryList* history_list;

    Place color_from;
    Vector<Vector<QColor>> text_color;
