#ifndef TRIVIAL_SCENE_NODE_HEADING3_WIDGET_H
#define TRIVIAL_SCENE_NODE_HEADING3_WIDGET_H
...
class TrivialSceneNodeHeading3Widget : public QTextEdit, public ITrivialSceneWidget {
    Q_OBJECT

public:
    TrivialSceneNodeHeading3Widget(QWidget* parent = NULL) : QTextEdit(parent) {

        setVerticalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
        setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOff);

        QObject::connect(this, &QTextEdit::textChanged, this, &TrivialSceneNodeHeading3Widget::OnTextChanged);
    ...
    void setObject(NodeBase* obj) override {
        object = obj;
        heading_node = qobject_cast<NodeHeading3*>(obj);
        if (heading_node) {
